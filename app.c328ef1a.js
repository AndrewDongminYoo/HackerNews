...
var NEWS_URL = 'https://api.hnpwa.com/v0/news/@id.json';
...
function newsFeed(pageNum) {
  var newsFeed = makeFeeds(getData(NEWS_URL.replace('@id', pageNum)));
  store.feeds = newsFeed;
  var newsList = [];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10944" + '/');
